...
public class DbConnConfig {
    ...
    public DbConnConfig(String dbtype, String host, Integer port, String user, String password_envar, String database_name) {
        this.dbtype = dbtype;
        this.host = host;
        this.port = port;
        this.user = user;
    ...
    public DbConnConfig dbtype(String dbtype) {
        this.dbtype = dbtype;
        return this;
    }

    public DbConnConfig host(String host) {
        this.host = host;
        return this;
    }

    public DbConnConfig port(Integer port) {
        this.port = port;
        return this;
    }

    public DbConnConfig user(String user) {
        this.user = user;
        return this;
    }

    public DbConnConfig password_envar(String password_envar) {
        this.password_envar = password_envar;
        return this;
    }

    public DbConnConfig database_name(String database_name) {
        this.database_name = database_name;
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof DbConnConfig)) {
            return false;
        }
        DbConnConfig dbConnConfig = (DbConnConfig) o;
